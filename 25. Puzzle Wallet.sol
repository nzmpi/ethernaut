...
1. proposeNewAdmin in Proxy -> pendingAdmin in Proxy == owner in Wallet
2. addToWhitelist in Wallet
3. need to deposit 0.001 eth, but write to balances twice
...
4. await contract.execute(player, toWei('0.002'), 0x0) -> withdrawing all eth
5. setMaxBalance(new owner)
